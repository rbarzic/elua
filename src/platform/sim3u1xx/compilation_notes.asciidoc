...
power source, this yields ~1.08 mA of current draw during sleep.  It
appears that this should be able to be lower.
...
* switch AHB clock to RTC, now down to 1.08 mA in PM3
