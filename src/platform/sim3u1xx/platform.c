...
static uint32_t const uart_mask[] = { SI32_CLKCTRL_A_APBCLKG0_UART0, SI32_CLKCTRL_A_APBCLKG0_UART1 };
...
u32 platform_uart_setup( unsigned id, u32 baud, int databits, int parity, int stopbits )
{
  ...
  SI32_CLKCTRL_A_enable_apb_to_modules_0(SI32_CLKCTRL_0, uart_mask[ id ]);
